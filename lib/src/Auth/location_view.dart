...
class _LocationViewState extends State<LocationView> {
  ...
  CameraPosition? cameraPosition = const CameraPosition( //innital position in map
...
void initState() {
  ...
  void addMarker()async{
    final Uint8List markerIcon = await getBytesFromAsset('assets/images/location.png', 300);
  ...
  void handleTap(LatLng argument) async{
    debugPrint(argument.toString());
      await placemarkFromCoordinates(argument.latitude, argument.longitude).then((value){
        List<Placemark> placemarks = value;
        setState(() {
      marker = [];
      marker.add(Marker(markerId: MarkerId(argument.toString()), position: argument ,icon: customIcon!));
      location = "${placemarks.first.administrativeArea}, ${placemarks.first.street}, ${placemarks.first.country}";
      address = location;
           ...
           child: InkWell(
            ...
            Container(
              ...
              var place = await PlacesAutocomplete.show(
                  ...
                  final plist = GoogleMapsPlaces(apiKey:googleMapsKey,
                   ...
                   mapController?.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: newlatlang, zoom: 17)));
                    setState(() {
                     ...
                     marker.add(Marker(markerId: MarkerId('$newlatlang'),position: newlatlang));
                     address = location;
               ...
               child: Container(
                ...
                decoration: BoxDecoration(
                 ...
                 child: Container(
                   ...
                   child: Text(location, style: const TextStyle(fontSize: 14),overflow: TextOverflow.ellipsis,),
                 ),
               ),
                       )
                     ),
