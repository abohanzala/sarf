...
// class InvoiceMembersHomeListScreen extends StatefulWidget {
//   final String expanseId;
//   final String budgetId;
//   const InvoiceMembersHomeListScreen(
//       {super.key, required this.expanseId, required this.budgetId});

//   @override
//   State<InvoiceMembersHomeListScreen> createState() =>
//       _InvoiceMembersHomeListScreenState();
// }

// class _InvoiceMembersHomeListScreenState
//     extends State<InvoiceMembersHomeListScreen> with RouteAware {
...
//     if (value.isEmpty) {
//       cityList =
//           ctr.getInvoiceMemberListHome('', widget.expanseId, widget.budgetId);
//       cityList?.then((value) {
//         var receive = value?.data?.fold(
//             0,
//             (previousValue, element) =>
//                 previousValue + (element.invoicesCount ?? 0));
//         var total = value?.data?.fold(
//             0,
//             (previousValue, element) =>
//                 previousValue + (element.invoicesSumAmount ?? 0));
//         var mem = value?.data?.fold(
//             0,
//             (previousValue, element) =>
//                 previousValue + (element.invoicesCount! > 0 ? 1 : 0));
//         setState(() {
...
//     cityList = ctr.getInvoiceMemberListHome(
//         searchValue.text, widget.expanseId, widget.budgetId);
//     cityList?.then((value) {
//       var receive = value?.data?.fold(
//           0,
//           (previousValue, element) =>
...
//                 left: kIsWeb == true ? Get.width * 0.11 : 16.w,
//                 top: 20.h,
//                 right: kIsWeb == true ? Get.width * 0.11 : 16.w),
//             height: 120.h,
...
//                     horizontal: kIsWeb == true ? 0 : 12, vertical: 8),
...
//                               border: Border.all(
//                                   color: R.colors.lightBlue, width: 1)),
//                           child: TextFormField(
//                             onTap: () {
...
//                                   }
//                                   if (snapshot.hasData) {
//                                     List<InvoiceMemberHome> data =
//                                         snapshot.data!.data!;
//                                     if (data.isNotEmpty) {
//                                       var sortedUsersDesc = data
//                                           .map((user) => user)
//                                           .toList()
//                                         ..sort((a, b) => b.newInvoice!
//                                             .compareTo(a.newInvoice!));
...
//                                             var singleData =
//                                                 sortedUsersDesc[index];
//                                             return GestureDetector(
//                                               onTap: () => Get.to(() =>
//                                                   InvoiceListScreenHome(
//                                                     memberID: singleData.id
//                                                         .toString(),
//                                                     expanseId: widget.expanseId,
...
//                                                             ),
//                                                             Text(
//                                                               "${singleData.invoicesSumAmount ?? 0}",
//                                                               style: TextStyle(
//                                                                   color: R
//                                                                       .colors
//                                                                       .black,
...
//                                                                     onTap: () {
//                                                                       launchUrls(
//                                                                           'https://twitter.com/${singleData.userDetail?.twitterLink}');
//                                                                     },
//                                                                     child: Image
//                                                                         .asset(
//                                                                       R.images
...
//                                                                     onTap: () {
//                                                                       launchUrls(
//                                                                           'https://instagram.com/${singleData.userDetail?.instaLink}');
...
//                                                                       launchWhatsApp(
//                                                                           singleData.userDetail?.whatsapp ??
//                                                                               "");
//                                                                     },
//                                                                     child: Image
//                                                                         .asset(
...
//                                                                             'tel',
//                                                                         path:
//                                                                             "${singleData.userDetail?.contactNo}", // your number
//                                                                       );
//                                                                       launchPhone(
//                                                                           u: teleLaunchUri);
//                                                                     },
...
//                                                                               '',
//                                                                       curretUserPhoto:
//                                                                           ctrProfile.profileModel?.user?.photo ??
//                                                                               '',
//                                                                       userFcm: singleData.androidDeviceId == ''
//                                                                           ? singleData.iosDeviceId ??
//                                                                               ''
//                                                                           : singleData.androidDeviceId ??
//                                                                               '',
//                                                                       currentFcm:
//                                                                           fcm,
//                                                                     ));
                          ...
                          if (snapshot.hasData) {
                            ...
                            if (data.isNotEmpty) {
                              var sortedUsersDesc = data
                                  ...
                                  .toList()
                                ..sort((a, b) =>
                                    b.newInvoice!.compareTo(a.newInvoice!));
                              return ListView.builder(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 12),
                                  itemCount: sortedUsersDesc.length,
