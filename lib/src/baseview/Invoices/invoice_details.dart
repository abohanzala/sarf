                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                ctr.inVoiceDetails.value.data!.createdDate!,
                                style: TextStyle(
                                    color: R.colors.grey,
                                    fontSize: 14,
                                    fontWeight: FontWeight.w500),
                          ...
                          Text(
                            ctr.inVoiceDetails.value.data!.customer!.name!,
                            style: TextStyle(
                                color: R.colors.black,
                                fontSize: 14,
                                fontWeight: FontWeight.w500),
                          ...
                          Text(
                            widget.isHome == true
                                ? Get.find<HomeController>()
                                    .selectedBudgetName
                                    .value
                                : ctr.inVoiceDetails.value.data!.user!.name!,
                            style: TextStyle(
                                color: R.colors.black,
                                fontSize: 14,
                                fontWeight: FontWeight.w500),
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  ctr.inVoiceDetails.value.data!.amount
                                      .toString(),
                                  style: TextStyle(
                                      color: R.colors.themeColor,
                                      fontSize: 14,
                ...
                child: Obx(
                  () => Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          GetStorage().read("userId").toString() ==
                                  ctr.inVoiceDetails.value.data?.userId
                                      .toString()
                              ? 'Sent Attachments'.tr
                            ...
                            children: [
                              Expanded(
                                child: ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: ctr.inVoiceDetails.value.data
                                        ?.attachments?.length,
                                    itemBuilder: (context, index) {
                                      var singleAttach = ctr.inVoiceDetails
                                          .value.data?.attachments?[index];
                      ...
                      if (ctr.inVoiceDetails.value.data?.invoiceFiles
                              ?.isNotEmpty ==
                          true)
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 12),
                              ...
                              Expanded(
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index1) {
                                      var singleAttach = ctr.inVoiceDetails
                                          .value.data?.invoiceFiles?[index1];
                                      return singleAttach?.files != null
                                          ? ListView.builder(
                                              shrinkWrap: true,
                                              primary: false,
                                              itemCount:
                                                  singleAttach?.files?.length,
                                              scrollDirection: Axis.horizontal,
                                              itemBuilder: (context, index) {
                                                var singleFile = ctr
                                                    .inVoiceDetails
