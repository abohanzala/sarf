        ...
        body: Stack(
          ...
          children: [
            Container(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: kIsWeb == true ? Get.width > 750 ?  Get.width * 0.21 : 0 : 0 ),
                child: Align(
            ...
            Container(
              ...
              child: SingleChildScrollView(
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: kIsWeb == true ?  Get.width > 750 ? Get.width * 0.2 : 0 : 0),
                  child: Column(
                    children: [
                      Container(
                        decoration: BoxDecoration(
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                         ...
                                         if(searching && ctr.searchedUsers.value.data != null) ...[
                                       Container(
                                        decoration: BoxDecoration(
                                          color: R.colors.white,
                                          borderRadius: BorderRadius.circular(10),
                      ...
                      GestureDetector(
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.list_alt,color: R.colors.white,),
                            const SizedBox(height: 8,),
                            Text("Generate Custom Invoice".tr,style: TextStyle(color: R.colors.white),),
                          ],
                        ),
                        ),
                      ),
