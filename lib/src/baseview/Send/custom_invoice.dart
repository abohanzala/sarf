                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Obx(() => Text(
                                      ctr.selectedBudgetName.value.tr,
                                      style: TextStyle(
                                          color: ctr.selectedBudgetName.value !=
                                                  "Select Category"
                                              ? R.colors.black
                                              : R.colors.grey),
                                    )),
                        ...
                        GestureDetector(
                              ...
                              Container(
                                ...
                                child: Obx(
                                  () => ListView.separated(
                                      ...
                                      itemCount:
                                          homeController.expenseTypes.length),
                                ),
                              ),
                            );
                          },
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Obx(() => Text(
                                      ctr.selectedExpName.value.tr,
                                      style: TextStyle(
                                          color: ctr.selectedExpName.value !=
                                                  "Select Expanse"
                                              ? R.colors.black
                                              : R.colors.grey),
                                    )),
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  if (ctr.selectedBudgetId.value == '') {
                                    Get.snackbar(
                                        'Error'.tr, "Category is required".tr);
                                    return;
                                  }

                                  if (ctr.selectedExptId.value == '') {
                                    Get.snackbar(
                                        'Error'.tr, "Expanse is required".tr);
                                    return;
                                  }

                                  if (ctr.amount22.text.isEmpty) {
                                    Get.snackbar(
                                        'Error'.tr, "amount is required".tr);
                                    return;
                                  }
                                  String b =
                                      replaceArabicNumber(ctr.amount22.text);
                                  ctr.postNewCustomInvoice(
                                      ctr.selectedBudgetId.value,
                                      ctr.selectedExptId.value,
                                      b,
                                      ctr.note33.text);
