      ...
      body: Obx(
        () => Column(
          ...
          children: [
            ...
            transform: Matrix4.translationValues(0, -10, 0),
             child: Padding(
               ...
               child: Container(
                      ...
                      margin:  EdgeInsets.symmetric(horizontal: kIsWeb == true ? Get.width > 750 ? 0 : 12 : 12),
           ...
           const SizedBox(height: 10,),
           Padding(
             padding:  EdgeInsets.symmetric(horizontal: kIsWeb == true ? Get.width * 0.11 : 12),
             child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
           ...
           Expanded(
             child: ListView.builder(
              padding:  EdgeInsets.symmetric(horizontal: kIsWeb == true ? Get.width * 0.11 : 12,vertical: 10),
              shrinkWrap: true,
