...
class _MembersScreenState extends State<MembersScreen> {
  ...
  _onChangeHandler(value) {
    searchValue.selection =
        TextSelection.collapsed(offset: searchValue.text.length);
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            customAppBar(
                'Members List'.tr, false, true, membersLenght, false, () {}),
            //appbarSearch(),
